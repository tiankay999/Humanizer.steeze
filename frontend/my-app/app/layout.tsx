  ...
  return (
    <html lang="en">
      <head>
        <script
          async
          src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1104510433068087"
        ...
        <script
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-DKDKJCVS9V"
        ></script>
        <script
